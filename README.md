...
Плюсы и минусы Дзена
    ...
    + Большая обойма, подходит для уничтожения щитов
    + 50хп 150щита
    --- Очень низкая мобильность
    -- Уязвим для фланкеров, снайперов, дробовиков
    - Низкий хил

Общие советы:
    - Сменить дискорд на вращение колеса мыши,и вверх и вниз.
        По умолчанию дискорд стоит на Е, что мешает одновременно двигаться вправо и вешать дискорд.
        Хил орба нажимается мизинцем, поэтому её менять не нужно.
(это рекомендации киберкотлет, лично я играю на страндартных, потому что средний палец нормально на колесе не держится)
    ...
    - Всегда манси, приседай, т.к большой хитбокс головы.
...
ПКМ\ЛКМ
    ...
    ПКМ:
        Если цель не стоит на месте, то во время выпуска пкм нужно немного спреить влево-вправо, т.к. шары прожектайл они летят некоторое время, и цель может немного переместиться. 
